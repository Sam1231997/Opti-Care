...
const Glasses =() =>{
  ...
  return(
    ...
    <div className="flex flex-col md:flex-row md:space-x-16 space-y-10 md:space-y-0 items-center  justify-center pb-20">
     <motion.div
      ...
      >
            ...
            <button className="p-2  font-bold text-white rounded-full w-40 bg-black hover:scale-95">
          Find out more
        </button>
          </motion.div>
          <motion.div 
