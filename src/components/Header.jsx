      ...
      <div className="mx-auto px-4 sm:px-8 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex text-l font-bold space-x-8 align-baseline">
            <a href="#home" className="text-gray-600  hover:text-black hover:bg-purple-300 px-4">Home</a>
            <a href="#services" className="text-gray-600 hover:text-black hover:bg-purple-300 px-4">About Us</a>
