  ...
  return (
    <section id="feature" ref={ref}>
      <div className="relative container flex flex-col max-w-6xl mx-auto my-32 md:space-y-0 px-6 text-gray-900 md:flex-row md:px-0 space-y-10">
        ...
        {/* Text Container */}
        <motion.div
          className="md:absolute md:right-0 top-28 border-purple-400 border-2 px-4 pb-5 rounded-md shadow-2xl shadow-purple-400"
          initial={{ opacity: 0, x: 100 }}  // Starts from the right
          animate={controls}
        >
          <h2 className="max-w-lg  mb-6 font-sans text-4xl text-center text-gray-900 uppercase md:text-5xl md:mt-4 md:text-left">
            About us
          </h2>
          <h4 className="max-w-lg   font-sans text-xl text-center text-gray-900 uppercase md:text-xl md:mt-4 md:text-left">
...
<p>Our facility is equipped with the most up-to-date technology to ensure the best eye care possible.</p>
            ...
            <button className="p-2  mt-4 font-bold text-white ml-32 rounded-full w-40 bg-black hover:scale-95">
          See more
        </button>
